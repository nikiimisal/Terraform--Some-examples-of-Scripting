...
resource "aws_instance" "nikhil_1" {
...
resource "aws_instance" "nikhil_2" {
  ami = "ami-0b46816ffa1234887"
  instance_type = "t3.micro"
  key_name = "server1"
  tags = {
...
resource "aws_instance" "nikhil_3" {
  ami = "ami-0b46816ffa1234887"
  instance_type = "t3.micro"
  key_name = "server1"
  tags = {
...
resource "aws_instance" "nikhil" {               # Define 
  ami = var.ami
...
module "ec2_instance" {
  source = "./modules/"      #calling
  instance_type = "t3.micro"   # overright command ..First priority command
}
